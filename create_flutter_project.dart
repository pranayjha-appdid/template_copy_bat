...
Future<void> main(List<String> args) async {
  if (args.length < 2) {
    print('Usage: dart create_flutter_project.dart project_name flutter_version org_name');
    print('Example: dart create_flutter_project.dart ecommerce_app 3.35.7 com');
    print('Example: dart create_flutter_project.dart grocery_app 3.35.7 com.examplecompany');
    exit(1);
  }
  ...
  const templateRepo = 'https://github.com/Akash-appdid/flutter-new-updated-getx-template.git';
...
Future<void> replacePubspecDependencies({
  ...
  final templateFromDependencies = templateDependenciesMatch.group(0)!.trimRight();
